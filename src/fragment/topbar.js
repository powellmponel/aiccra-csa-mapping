          ...
          <div className="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul className="navbar-nav navbar-nav-right">
              <li className="nav-item dropdown d-none d-lg-block">
                <a className="nav-link btn btn-success create-new-button" key="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="#">+ Create New Project</a>
              ...
              <li className="nav-item dropdown border-left">
                <a className="nav-link count-indicator dropdown-toggle" key="messageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              ...
              <li className="nav-item dropdown border-left">
                <a className="nav-link count-indicator dropdown-toggle" key="notificationDropdown" href="#" data-toggle="dropdown">
              ...
              <li className="nav-item dropdown">
                <a className="nav-link" key="profileDropdown" href="#" data-toggle="dropdown">
